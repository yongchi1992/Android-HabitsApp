...
public class MainUI extends Activity implements BluetoothAdapter.LeScanCallback {
	/*
	...
	String[] menuItems = { "Home","Dashboard", "Profile", "Connect","Logout" };
...
class ProfileFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		welcome.setText("Welcome "+userName+"!\nYour current weight is \nYour goal weight is \nBased on your age and weight, your BMI is \n");
...
class ConnectFragment extends Fragment implements BluetoothAdapter.LeScanCallback{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SetupButton.setOnClickListener(new ImageButton.OnClickListener() 
        {
            @Override
            public void onClick(View v) 
            {
...
class SummaryFragment extends Fragment{
	...
	LinearLayout layout;
	GraphicalView view;
	LineGraph today = new LineGraph("#FFFB00");
	LineGraph week = new LineGraph("#FF4400");
	LineGraph month = new LineGraph("#3399FF");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		int[] values = {1,2,3,0,5,6,10,4,3,2,11};
		today.addPoints(values);
		view.repaint();
		...
		prev.setOnClickListener(new OnClickListener() {	
			...
			public void onClick(View v) {
				...
				if(current == 0){
					...
					int[] values = {1,2,3,5,6,0,4,3,2,11};
					today.addPoints(values);
					view.repaint();
				}else if(current == 2){
					current = 1;
					...
					int[] values = {13,4,0,5,6,10,4,3,2,11};
					week.addPoints(values);
					view.repaint();
				}
