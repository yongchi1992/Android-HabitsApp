...
public class DataHandlerService extends Service {
    ...
    //public static String shortUuidFormat = "00002220-0000-1000-8000-00805F9B34FB";
...
//                Log.v(TAG, "COUNTER: " + Float.toString(event.getFloat1()));
                ...
                if (count >= 5) {
                    ...
                    bIntent.putExtra(StreamActivity.B_DATA_ACC_Y, event.getFloat1());
                    bIntent.putExtra(StreamActivity.B_DATA_ACC_Z, event.getFloat2());
                    bIntent.putExtra(StreamActivity.B_DATA_AUDIO, event.getFloat3());
